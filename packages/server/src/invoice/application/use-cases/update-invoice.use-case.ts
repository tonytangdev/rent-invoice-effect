...
import { InvoiceNotFoundError, InvalidInvoiceError, UpdateInvoiceRequest } from "api/schemas/invoice"
...
export class UpdateInvoiceUseCase extends Context.Tag("UpdateInvoiceUseCase")<
  ...
  {
    execute: (id: string, input: typeof UpdateInvoiceRequest.Type) => Effect.Effect<Invoice, InvoiceNotFoundError | InvalidInvoiceError>
  }
>() {}
